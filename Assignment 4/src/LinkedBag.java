...
// or null otherwise.
    ...
    public T remove() {
        ...
        if(x!=0)
        {
        	Node current=firstNode,prev=null;
        	for(int i=0;i<x;i++)
        	{
    ...
    public boolean equals(LinkedBag<T> aBag) {
        ...
        if(this.numberOfEntries != aBag.numberOfEntries)//if not equals then false
        	return result;
        
        Node scout=this.firstNode;
        
        
        //A bag is said to be equal to another bag if both conatin same no of elements with the same frequency
        
        
        for(int i=0;i< numberOfEntries;i++)
        {
        	int f1=this.getFrequencyOf(scout.data);   //get the freq of the ith element for the calling object this
        	int f2=aBag.getFrequencyOf(scout.data);   //get the freq of the ith element for the Abag object
        	if(f1!=f2)
        		return result;//if freq of two bags not equal then false
        	scout=scout.next;
        }
    ...
    public void removeDuplicates() {
    	if(this.firstNode==null)//return NULL if bag is empty
    		return;
